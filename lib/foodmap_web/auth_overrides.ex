defmodule FoodmapWeb.AuthOverrides do
  ...
  override AshAuthentication.Phoenix.Components.Banner do
    ...
    set :root_class, "flex flex-col items-center justify-center mb-6"
    # Adjust size as needed
    set :image_class, "h-24 w-auto mb-2"
  end
  ...
  override AshAuthentication.Phoenix.Components.Password.RegisterForm do
    ...
    set :label_class, "text-gray-700 font-bold block mb-1"
    set :input_class, "w-full p-3 bg-gray-50 border border-gray-300 rounded-xl text-black"

    # Make the button look like a button, not a line
    set :submit_class, "w-full py-4 bg-blue-600 text-white font-bold rounded-xl mt-4"
  end
