  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender Foodmap.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource Foodmap.Accounts.Token
      signing_secret Foodmap.Secrets
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender Foodmap.Accounts.User.Senders.SendPasswordResetEmail
